  ...
  return (
    <div className="pb-40 lg:max-w-7xl lg:mx-auto lg:my-0">
      <div className="relative w-full h-32 sm:h-40 md:h-52">
        <div className="absolute left-1/2 -translate-x-1/2 bottom-3 md:bottom-4 -rotate-6 transition ease-in-out bg-rose-200 dark:bg-rose-300 w-40 h-14 md:w-52 md:h-16 rounded-[50%]"></div>
        <h1
          className={`absolute left-1/2 -translate-x-1/2 bottom-6 md:bottom-7 text-2xl md:text-3xl font-["MangoByeolbyeol"] text-white`}
        >
          오늘의 티니핑
        </h1>
        <div className="absolute left-[57%] lg:left-[55%] bottom-14 md:bottom-16">
          <svg
